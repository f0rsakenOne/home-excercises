...
public class CarService {
  ...
  public void getExpensive() {
    ...
    System.out.println(
        expensiveCar.getName() + " is the most expensive car (" + expensiveCar.getPrice() + "$)");
  }
  ...
  public void getCheapest() {
    ...
    System.out.println(
        cheapestCar.getName() + " is the most cheapest car (" + cheapestCar.getPrice() + "$)");
  }

  public void getCarWithXOrMoreManufacturers(int manufacturerCount) {
    for (Car car : carService.values()) {
      if (car.getManufacturer().size() >= manufacturerCount) {
